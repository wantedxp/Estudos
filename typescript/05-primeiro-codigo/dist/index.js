function sendSpaceship(name, captain) {
    ...
    alert("A nave ".concat(spaceship.name, " com o Comandante: ").concat(spaceship.captain, " foi enviada em uma miss\u00E3o."));
    return spaceship;
}
...
var speed = Number(prompt('Informe a velocidade da nave'));
